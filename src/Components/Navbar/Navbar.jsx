...
export default function NavBar(props) {
  return (
    <div>
      <div>
        <nav
          className="navbar navbar-expand-lg bg-body-tertiary h-20 "
          data-bs-theme="black"
        >
            ...
            >
              ...
              <form className="d-flex" role="search">
                <label className={styles["theme-switch"]}>
                  <input
                    onClick={props.toggleMode} // Ensure the prop name is correct here
                    type="checkbox"
                  ...
                  <div className={styles["theme-switch__container"]}>
                    ...
                    <div className={styles["theme-switch__stars-container"]}>
                      <svg
                        ...
                        viewBox="0 0 144 55"
                        fill="none"
                        className={styles["theme-switch__svg"]}
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                    ...
                    <div className={styles["theme-switch__circle-container"]}>
                      <div
                        className={styles["theme-switch__sun-moon-container"]}
                      >
